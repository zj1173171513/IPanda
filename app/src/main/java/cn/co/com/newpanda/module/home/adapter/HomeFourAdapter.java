...
class HomeFourAdapter extends RecyclerView.Adapter<HomeFourAdapter.ViewHolder> {

    private Context context;
    private List<HomeBean.DataBean.PandaliveBean.ListBean> list;

    public HomeFourAdapter(Context mContext, List<HomeBean.DataBean.PandaliveBean.ListBean> list) {
