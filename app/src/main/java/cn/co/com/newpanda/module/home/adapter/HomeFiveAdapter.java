...
class HomeFiveAdapter extends RecyclerView.Adapter<HomeFiveAdapter.ViewHolder> {

    private Context context;
    private List<HomeBean.DataBean.WallliveBean.ListBeanX> list;

    public HomeFiveAdapter(Context mContext, List<HomeBean.DataBean.WallliveBean.ListBeanX> list) {
